...
import { p as postJson } from './api-BbKnJ9mL.js';
import { M as Modal, f as formatMetric, n as normalizeSupplementUnit, E as Empty, F as Field, I as Input, i as inputClassName } from './ui-CBKJWVKY.js';
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        !preview && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: loading ? "Gemini schätzt…" : "Schätzen"
          }
        ),
        preview && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-white/10 bg-slate-950/60 p-4 text-sm animate-in fade-in slide-in-from-top-2 duration-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-slate-100", children: preview.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.18em] text-slate-500", children: preview.default_time_of_day })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-400", children: [
            formatMetric(preview.default_dose ?? 0),
            " ",
            preview.unit
          ] }),
          preview.notes && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-slate-500 italic", children: preview.notes }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: loading ? "Speichern…" : "In Katalog"
              }
            )
          ] })
        ] }),
        error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-rose-300", children: error })
      ] })
    }
  );
}
...
const {Flame,Pill,Settings2,Sparkles,Minus} = await importShared('lucide-react');
const supplementSchema = objectType({
  date: stringType().min(1),
  supplement_id: stringType().min(1, "Bitte ein Supplement waehlen."),
  dose: coerce.number().min(0),
  unit: stringType().min(1),
  time_of_day: stringType().min(1),
...
function SupplementsView({ date, sup, catalog, suppLog }) {
  ...
  const createSupplementMutation = useMutation({
    mutationFn: (values) => postJson("/supplements/log", {
      date: values.date,
      intake: {
  ...
  const deleteSupplementMutation = useMutation({
    mutationFn: ({ date: intakeDate, delete_id }) => postJson("/supplements/log", { date: intakeDate, delete_id }),
    onSuccess: (_, values) => {
      queryClient.invalidateQueries({ queryKey: ["supp-log", values.date] });
      queryClient.invalidateQueries({ queryKey: ["supp-stats", values.date] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-6 xl:grid-cols-[1.05fr_0.95fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "Quick log" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-400", children: "Ein Tap mit den Katalog-Defaults. Gut fuer die Standard-Stack-Routine." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full border border-white/10 bg-slate-950/60 px-3 py-1 text-xs uppercase tracking-[0.18em] text-slate-400", children: date })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-2 xl:grid-cols-3", children: quickCatalog.length ? quickCatalog.map((item) => {
                  ...
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-slate-100", children: item.name }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.18em] text-slate-500", children: item.default_time_of_day })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-sm text-slate-400", children: [
                        formatMetric(item.default_dose ?? 0),
                        " ",
                        normalizeSupplementUnit(item.unit)
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-xs uppercase tracking-[0.18em] text-orange-200", children: count > 0 ? `${count}x heute im Stack` : "heute noch nicht im Stack" })
                    ]
                  }
                ),
        ...
        }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { text: "Kein Quick-Log-Katalog verfuegbar." }) }),
        createSupplementMutation.isError ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-rose-300", children: createSupplementMutation.error.message }) : null
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: supplementForm.handleSubmit((values) => createSupplementMutation.mutate(values)), className: "rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { className: "h-5 w-5 text-violet-300" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Supplement logger" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-400", children: "Loggt direkt nach `/supplements/log` fuer das gewaehlte Datum." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "rounded-full border border-white/10 bg-slate-950/60 px-3 py-1 text-xs uppercase tracking-[0.18em] text-slate-400", children: [
            intakes.length,
            " intakes"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Datum", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", ...supplementForm.register("date") }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Supplement", children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { className: inputClassName, ...supplementForm.register("supplement_id"), children: catalog.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: item.id, children: item.name }, item.id)) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Dose", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", min: "0", step: "0.1", ...supplementForm.register("dose") }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Unit", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { ...supplementForm.register("unit") }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Time of day", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: inputClassName, ...supplementForm.register("time_of_day"), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Notizen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "optional", ...supplementForm.register("notes") }) })
        ] }),
        supplementForm.formState.errors.supplement_id ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-rose-300", children: supplementForm.formState.errors.supplement_id.message }) : null,
        createSupplementMutation.isError ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-rose-300", children: createSupplementMutation.error.message }) : null,
        createSupplementMutation.isSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-emerald-300", children: "Supplement gespeichert." }) : null,
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { disabled: createSupplementMutation.isPending || catalog.length === 0, className: "mt-4 inline-flex items-center gap-2 rounded-full bg-violet-300 px-5 py-3 font-medium text-slate-950 disabled:opacity-60", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { className: "h-5 w-5 text-violet-300" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "Today stack" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", children: intakes.length ? intakes.slice().reverse().map((intake) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-white/10 bg-slate-950/60 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-slate-100", children: intake.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 text-xs uppercase tracking-[0.18em] text-slate-500", children: [
              formatMetric(intake.dose),
              " ",
              intake.unit,
              " · ",
              intake.time_of_day
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-sm text-slate-400", children: intake.notes || "Keine Notizen" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        ] }) }, intake.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { text: "Fuer dieses Datum sind noch keine Supplements geloggt." }) }),
        deleteSupplementMutation.isError ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-rose-300", children: deleteSupplementMutation.error.message }) : null
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { className: "h-5 w-5 text-violet-300" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "30-day stats" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 md:grid-cols-2", children: stats.length ? stats.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-white/10 bg-slate-950/60 p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: row.supplement.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-slate-400", children: [
              row.days_taken,
              "d"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-sm text-slate-400", children: [
            "Streak ",
            row.current_streak,
            " days"
          ] })
        ] }, row.supplement.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { text: "Keine Supplements geladen" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Settings2, { className: "h-5 w-5 text-slate-300" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "Catalog" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", children: catalog.length ? catalog.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-white/10 bg-slate-950/60 p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
        ...
        ] }, item.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { text: "Kein Supplement-Katalog geladen." }) })
      ] }),
      geminiOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(GeminiCatalogModal, { onClose: () => setGeminiOpen(false), onSaved: () => {
        setGeminiOpen(false);
        queryClient.invalidateQueries({ queryKey: ["supp-catalog"] });
      } })
    ] })
  ] });
}

export { SupplementsView as default };
