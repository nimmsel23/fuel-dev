...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-C3Pr5fKJ.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-hviIjgZd.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'lucide-react':{get:()=>()=>__federation_import(new URL('__federation_shared_lucide-react-DoaLvj6_.js', import.meta.url).href),import:true}};
